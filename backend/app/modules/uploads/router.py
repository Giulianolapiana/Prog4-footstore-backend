...
from app.modules.uploads.service import ImageService
from app.modules.uploads.schemas import ImagePublic

router = APIRouter(prefix="/uploads", tags=["Uploads Management"])
